...
if True:
    ...
    def activiatWindow():
        # w.setWindowFlags(QtCore.Qt.WindowStaysOnTopHint) # windows always on top
        # w.activateWindow()
        # w.raise_
        pass
    a3 = QAction('activiat', triggered=activiatWindow)
    tpMenu = QMenu()
    tpMenu.addAction(a1)
    tpMenu.addAction(a2)
    tpMenu.addAction(a3)
