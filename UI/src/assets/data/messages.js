  ...
  "Português (Brasil)": {
    ...
    str: {
      ...
      error: {
        ...
        localApiError:
          "Por favor, habilite a opção ferramentas de terceiros no cliente do jogo",
      },
      regions: {
        americas: "Américas",
        europe: "Europa",
  ...
  日本語: {
    ...
    str: {
      ...
      error: {
        ...
        playerNoHistory: "対戦履歴が見つかりません",
        localApiError:
          "本ソフトを使うには、ゲーム設定の「サードパーティーエンドポイントを有効にする」をチェックしてください",
      },
      regions: {
        americas: "アメリカサーバー",
        europe: "ヨーロッパサーバー",
    ...
    loading: {
      readyToRock: "準備万端 🤘",
      history: "対戦履歴を読み込み中...",
      nohistory: "対戦履歴が見つかりません",
    },
    tracker: {
      tabs: {
        oppoPlayed: "相手がプレイしたカード",
        myPlayed: "自分がプレイしたカード",
      },
      cardsInHand: "手札枚数: {num}",
    },
    leaderboard: {
      rank: "ランキング",
      name: "プレイヤー名",
    ...
    matches: {
      ...
      badges: {
        Ranked: "ランク戦",
        Bo3Challenge: "フレンドとのBO3対戦",
        StandardGauntlet: "スタンダードガントレット",
        Normal: "ノーマル戦",
        LastCallQualifierGauntlet: "ラストチャンスガントレット",
        SeasonalTournament: "シーズントーナメント",
      },
    },
    dash: {
      winRate: "勝率",
      winloss: "{win}勝ち {loss}負け",
    },
    search: {
      leaderboard: {
        base: "検索",
        numPlayer: " {num} 人のプレイヤーから検索",
      },
      player: {
        placeholder: "例えば：Storm#5961",
      },
      prompt: "⬆ プレイヤー名とハッシュタグを入力してください",
    },
    tooltips: {
      lorlogin: "LoRがログインしていません",
    },
    contact: {
      messageBox: {
        placeholder: "アドバイスを送ってくれない？",
        messageSent: "送信しました",
        confirm: "確認します？",
        send: "送信",
      },
      contactUs: "開発者を連絡",
      broughtWithLove: "あなたのために❤️を注いで作った:",
    },
    settings: {
      options: {
        autoLaunch: "パソコン起動時に本ソフトを自動起動する:",
      },
      enabled: "起動する",
      enable: "起動する",
      disabled: "起動しない",
