<template>
  <div class="flex h-full justify-center">
    ...
    <div class="w-0 max-w-xl flex-1">
      <!-- Vertical Flex -->
      <div
        class="flex h-full flex-col items-center justify-center px-2 text-center sm:px-0"
      >
        <div
        ...
        >
          ...
          <router-link
            ...
            ><div
              class="rounded-md bg-gray-600 p-2 px-6 text-center transition-colors hover:bg-gray-500"
            >
        ...
        <div class="mt-4 max-w-[220px] text-gray-200">
