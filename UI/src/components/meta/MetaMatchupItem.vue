<template>
  <div
    class="flex flex-col mb-4 sm:mb-2 sm:flex-row justify-center items-center">
    <deck-preview class="max-w-[200px] md:mr-2" :fixedWidth="true" :deck="
        metaGroups
    ...
    <div class=" text-center sm:text-left sm:flex gap-2 sm:gap-0 flex-col">
      ...
      <p class="text-sm text-gray-200">
        {{ $t("matches.games", { num: matchup.match_num }) }}</p>
      <p class="text-lg">
        {{
          $t("matches.winRate", {
